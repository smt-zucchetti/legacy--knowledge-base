...
Route::get('/allArticles', 'ArticleController@allArticles');
...
Route::get('/uploadGDocZip', 'ArticleController@importGDoc');
Route::post('/uploadGDocZip', 'ArticleController@importGDoc');
